...
public class AdvancedJTable_quotasUsage extends AdvancedJTable_networkElement<OpenStackQuotasUsage> {
    ...
    public List<AjtColumnInfo<OpenStackQuotasUsage>> getNonBasicUserDefinedColumnsVisibleOrNot() {
        ...
        res.add(new AjtColumnInfo<OpenStackQuotasUsage>(this, String.class, null, "Project ", " Project name", null, n -> callback.getOpenStackNet().getOpenStackNetworkElementByOpenStackId(n.getProject().getId()), AGTYPE.NOAGGREGATION, null, null));
