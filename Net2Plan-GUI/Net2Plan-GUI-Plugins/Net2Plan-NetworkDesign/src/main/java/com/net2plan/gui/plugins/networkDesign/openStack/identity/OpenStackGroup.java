...
public class OpenStackGroup  extends OpenStackNetworkElement
{
    ...
    public static OpenStackGroup createFromAddGroup (OpenStackNet osn , Group group, OpenStackClient openStackClient)
    {
        final OpenStackGroup res = new OpenStackGroup(osn,group,openStackClient);
    ...
    private OpenStackGroup (OpenStackNet osn,  Group group , OpenStackClient openStackClient )
    {
        super (osn ,  null, (List<OpenStackNetworkElement>) (List<?>) openStackClient.openStackGroups,openStackClient);
        this.osGroup = group;
    }
    ...
    public void setGroupName (JSONObject jsonObject) {
        try{
        this.openStackClient.getClient().identity().groups().update(osGroup.toBuilder().name(jsonObject.getString("Name")).build());
        }catch(Exception ex){
    ...
    public void setGroupDescription (JSONObject jsonObject) {
        try{
        this.openStackClient.getClient().identity().groups().update(osGroup.toBuilder().description(jsonObject.getString("Description")).build());
        }catch(Exception ex){
    ...
    public void setGroupDomainId (JSONObject jsonObject) {
        try{
        this.openStackClient.getClient().identity().groups().update(osGroup.toBuilder().domainId(jsonObject.getString("Domain ID")).build());
        }catch(Exception ex){
