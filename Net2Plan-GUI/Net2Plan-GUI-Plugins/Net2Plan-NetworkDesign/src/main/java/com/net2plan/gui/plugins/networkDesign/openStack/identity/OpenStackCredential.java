...
public class OpenStackCredential extends OpenStackNetworkElement
{
    ...
    public static OpenStackCredential createFromAddCredential (OpenStackNet osn , Credential credential, OpenStackClient openStackClient)
    {
        final OpenStackCredential res = new OpenStackCredential(osn,credential,openStackClient);
    ...
    private OpenStackCredential (OpenStackNet osn, Credential credential ,OpenStackClient openStackClient)
    {
        super (osn ,  null, (List<OpenStackNetworkElement>) (List<?>) openStackClient.openStackCredentials,openStackClient);
...
try{
    ...
    public void setCredentialProjectId (JSONObject jsonObject) {
        try{
            this.openStackClient.getClient().identity().credentials().update(osCredential.toBuilder().projectId(jsonObject.getString("Project ID")).build());
        }catch(Exception ex){
    ...
    public void setCredentialBlob (JSONObject jsonObject) {
        try{
            this.openStackClient.getClient().identity().credentials().update(osCredential.toBuilder().blob(jsonObject.getString("Blob")).build());
        }catch(Exception ex){
    ...
    public void setCredentialType (JSONObject jsonObject) {
        try{
            this.openStackClient.getClient().identity().credentials().update(osCredential.toBuilder().type(jsonObject.getString("Type")).build());
        }catch(Exception ex){
