...
public class AdvancedJTable_servers extends AdvancedJTable_networkElement<OpenStackServer>
{
    ...
    public List<AjtColumnInfo<OpenStackServer>> getNonBasicUserDefinedColumnsVisibleOrNot()
    {
        ...
        res.add(new AjtColumnInfo<OpenStackServer>(this, String.class, null, "Host", "Server host", null, n -> callback.getOpenStackNet().getOpenStackNetworkElementByOpenStackId(n.getServerHost()), AGTYPE.NOAGGREGATION, null, null));
