...
public class OpenStackDomain extends OpenStackNetworkElement
{
    ...
    public static OpenStackDomain createFromAddDomain (OpenStackNet osn, Domain domain , OpenStackClient openStackClient)
    {
        final OpenStackDomain res = new OpenStackDomain(osn,domain,openStackClient);
    ...
    private OpenStackDomain (OpenStackNet osn, Domain domain, OpenStackClient openStackClient  )
    {
        super (osn ,  null, (List<OpenStackNetworkElement>) (List<?>) openStackClient.openStackDomains,openStackClient);
    ...
    public void setDomainName (JSONObject jsonObject) {
        try{
        this.openStackClient.getClient().identity().domains().update(osDomain.toBuilder().name(jsonObject.getString("Name")).build());
        }catch(Exception ex){
    ...
    public void setDomainDescription(JSONObject jsonObject) {
        try{
        this.openStackClient.getClient().identity().domains().update(osDomain.toBuilder().description(jsonObject.getString("Description")).build());
        }catch(Exception ex){
