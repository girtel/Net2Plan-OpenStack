...
public class AdvancedJTable_images extends AdvancedJTable_networkElement<OpenStackImage>
{
    ...
    public List<AjtColumnInfo<OpenStackImage>> getNonBasicUserDefinedColumnsVisibleOrNot()
    {
        ...
        res.add(new AjtColumnInfo<OpenStackImage>(this, Integer.class, null, "Updated", "Credentials links",
                null, n -> n.getImageUpdated(), AGTYPE.NOAGGREGATION, null, null));
        res.add(new AjtColumnInfo<OpenStackImage>(this, Map.class, null, "Metadata", "Credentials links",
                null, n -> n.getImageMetaData(), AGTYPE.NOAGGREGATION, null, null));
        res.add(new AjtColumnInfo<OpenStackImage>(this, Integer.class, null, "MinDisk", "Credentials links",
                null, n -> n.getImageMinDisk(), AGTYPE.NOAGGREGATION, null, null));
        res.add(new AjtColumnInfo<OpenStackImage>(this, Integer.class, null, "MinRam", " links",
