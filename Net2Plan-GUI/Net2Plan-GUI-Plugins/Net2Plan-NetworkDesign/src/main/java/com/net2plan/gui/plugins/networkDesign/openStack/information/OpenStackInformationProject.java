...
public class OpenStackInformationProject extends OpenStackNetworkElement
{
    ...
    public static OpenStackInformationProject createFromAddInformationProject (OpenStackNet osn , Project project)
    {
        final OpenStackInformationProject res = new OpenStackInformationProject(osn,project);
    ...
    private OpenStackInformationProject (OpenStackNet osn,Project project )
    {
        super (osn ,  null, (List<OpenStackNetworkElement>) (List<?>) osn.openStackInformationProject);
